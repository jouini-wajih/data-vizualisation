...
.text('Number of students');
  ...
  const labelsSucceed = svg.selectAll('.value-label-succeed_M')
    .data(Fedus)
    .enter()
    .append('text')
    .attr('class', 'value-label-succeed_M')
  ...
  const labelsFail = svg.selectAll('.value-label-fail_M')
    .data(Fedus)
    .enter()
    .append('text')
    .attr('class', 'value-label-fail_M')
